...
if (isset($_POST['submitRecord'])) {
  ...
  if ($per_lot_rebate == "3" || $per_lot_rebate == "8" || $per_lot_rebate == "5" || $per_lot_rebate == "10") {
    @$per_lot_rebate = $_POST['per_lot_rebate'] . '';
  } else {
    @$per_lot_rebate = $_POST['per_lot_rebate'] . '%';
  }
  // $my_sign = "%";
  // $per_lot_rebate = $per_lot_rebate . '' . $my_sign;
  ...
  // $my_signn = "%";
  // $willingness_to_join_us = $willingness_to_join_us . '' . $my_signn;
  ...
  $query = "INSERT INTO `tbl_clients_records`(`client_name`, `client_email`, `client_number`, `client_id`,`trading_experience`, `ib_experience`, `ib_of_broker`, `active_clients`, `per_lot_rebate`, `other_benefits`, `services`, `marketing`, `how_did_you_know_us`, `monthly_deposited_clients`, `monthly_lots`, `what_you_want`, `starting_date_time`, `follow_up_date_time`, `staff_opinion`, `willingness_to_join_us`, `comments`, `added_on`, `added_by`) VALUES ('$client_name','$client_email','$client_number','$client_id','$trading_experience','$ib_experience','" . str_replace(' , ', ', ', $ib_of_broker) . "','$active_clients','$per_lot_rebate','" . str_replace(' , ', ', ', $other_benefits) . "','" . str_replace(' , ', ', ', $services) . "','" . str_replace(' , ', ', ', $marketing) . "','" . str_replace(' , ', ', ', $how_did_you_know_us) . "','$monthly_deposited_clients','$monthly_lots','" . str_replace(' , ', ', ', $what_you_want) . "','$starting_date_time','$follow_up_date_time','$staff_opinion','$willingness_to_join_us','$comments','$added_on','$get_id')";
  // die($query);
...
<div class="" style="background:#fff;padding:10px;margin-top:10px">
  <form method="post">
    ...
    <div class="row" style="margin:0px">
      <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12">
        <div class="form-group">
          <label for="first">Client ID</label>
          <input type="text" class="form-control" name="client_id" placeholder="Client ID" id="first">
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="client_name" placeholder="Client Name" id="first">
        </div>
      </div>
      <!--  col-md-6   -->
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
        <div class="form-group">
          ...
          <input type="email" class="form-control" name="client_email" placeholder="Client E-mail" id="last">
        </div>
      </div>
      <!--  col-md-6   -->
      ...
      <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="client_number" placeholder="Client Number" id="first">
        </div>
      </div>
    </div>
    <!-- 
    ***********************************************************
 -->
    <!-- <p for="trading_experience" class="para_1" style="text-align: center;color:#4e73df;font-weight:bold;margin:0%"></p> -->


    <div class="row">
      <div class="col-lg-8">
        <p for="trading_experience" style="text-align: center;color:#4e73df;font-weight:bold" class="para_1">CLIENT BACKGROUND & POTENTIAL</p>
      </div>
      <div class="col-lg-2">
        <p for="trading_experience" style="text-align: center;color:#4e73df;font-weight:bold" class="para_1">HOW IS HE BRINGING BUSINESS</p>
      </div>
      <div class="col-lg-2">
        <p for="trading_experience" style="text-align: center;color:#4e73df;font-weight:bold" class="para_1">FOR OUR STATS</p>
      </div>
    </div>
      ...
      <div class="col-lg-8">
        <div class="row">
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="radio">
              <label>
                <input type="radio" name="trading_experience" id="trading_experience" value="0"> 0 Year+
              </label>

            </div>
            <div class="radio">
              <label>
                <input type="radio" name="trading_experience" id="trading_experience" value="1"> 1 Years+
              </label>
            </div>
            <div class="radio">
              <label>
          ...
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="radio">
              <label>
                <input type="radio" name="ib_experience" id="ib_experience" value="0"> 0 Year+
              </label>

            </div>
            <div class="radio">
              <label>
                <input type="radio" name="ib_experience" id="ib_experience" value="1"> 1 Years+
              </label>
            </div>
            <div class="radio">
              <label>
          ...
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="input-group mb-3">
              <input type="text" name="ib_of_broker[]" class="form-control" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
          ...
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="1-3"> 1 - 3
              </label>

            </div>
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="3-7"> 3 - 7
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="7-12"> 7 - 12
              </label>

            </div>
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="12-18"> 12 - 18
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="18-25"> 18 - 25
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="25-50"> 25 - 50
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="50-80"> 50 - 80
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" name="active_clients" id="active_clients" value="80+100+"> 80 - 100+
              </label>
            </div>
          </div>
          ...
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="radio">
              <label>
                <input type="radio" onclick="radioButton1(this)" name="per_lot_rebate" id="per_lot_rebate" class="per_lot_class" value="3"> 3+
              </label>

            </div>
            <div class="radio">
              <label>
                <input type="radio" onclick="radioButton1(this)" name="per_lot_rebate" class="per_lot_class" id="per_lot_rebate" value="5"> 5+
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" onclick="radioButton1(this)" name="per_lot_rebate" class="per_lot_class" id="per_lot_rebate" value="8"> 8+
              </label>
            </div>
            <div class="radio">
              <label>
                <input type="radio" onclick="radioButton1(this)" name="per_lot_rebate" class="per_lot_class" id="per_lot_rebate" value="10"> 10+
              </label>
            </div>
            ...
            <div class="input-group mb-3">
              <input type="text" name="per_lot_rebate" id="other_textbox1" disabled class="form-control" placeholder="Other / Spread Share %" aria-label="Other / Spread Share %" aria-describedby="basic-addon2">
              <div class="input-group-append">
                <span class="input-group-text" id="basic-addon2">%</span>
              </div>
            </div>
          ...
          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="input-group mb-3">
              <input type="text" name="other_benefits[]" class="form-control" id="other_benefits" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
              <div class="input-group-append">
                <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
              </div>
            </div>
      ...
      <div class="col-lg-4">
        <div class="row">
          <div class="col-xl-4 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="input-group mb-3">
              <input type="text" name="services[]" class="form-control" id="services" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
              <div class="input-group-append">
                <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
              </div>
            </div>
          ...
          <div class="col-xl-4 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="input-group mb-3">
              <input type="text" name="marketing[]" class="form-control" id="marketing" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
              <div class="input-group-append">
                <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
              </div>
            </div>
          ...
          <div class="col-xl-4 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
            ...
            <div class="input-group mb-3">
              <input type="text" name="how_did_you_know_us[]" class="form-control" id="how_did_you_know_us" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
              <div class="input-group-append">
                <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
        ...
        <div class="radio">
          <label>
            <input type="radio" onclick="radioButton2(this)" name="monthly_deposited_clients" id="monthly_deposited_clients" value="5"> 5+
          </label>

        </div>
        <div class="radio">
          <label>
            <input type="radio" onclick="radioButton2(this)" name="monthly_deposited_clients" id="monthly_deposited_clients" value="10"> 10+
          </label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" onclick="radioButton2(this)" name="monthly_deposited_clients" id="monthly_deposited_clients" value="20"> 20+
          </label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" onclick="radioButton2(this)" name="monthly_deposited_clients" id="monthly_deposited_clients" value="50"> 50+
          </label>
        </div>
        ...
        <!-- <div class="radio">
          <label>Other
            <input type="text" name="monthly_deposited_clients" id="other_textbox2" disabled placeholder="Other ">
          </label>
        </div> -->

        <div class="input-group mb-3">
          <input type="text" name="monthly_deposited_clients" class="form-control" disabled id="other_textbox2" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
          <div class="input-group-append">
            <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
          </div>
        </div>
      ...
      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
        ...
        <!-- <div class="radio">
          <label>Other
            <input type="text" name="monthly_lots" id="other_textbox3" disabled placeholder=" Other">
          </label>
        </div> -->

        <div class="input-group mb-3">
          <input type="text" name="monthly_lots" class="form-control" disabled id="other_textbox3" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
          <div class="input-group-append">
            <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
          </div>
        </div>
      ...
      <!-- **************************** -->
      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
        <p style="text-align: center;color:#4e73df;font-weight:bold;float:left" class="para_1">What you want?</p><br><br><br>

        <div class="radio">
          <label>
            <input type="checkbox" name="what_you_want[]" id="what_you_want" value="Local-Service"> Local Service
          </label>
        ...
        <div class="input-group mb-3">
          <input type="text" name="what_you_want[]" class="form-control" id="what_you_want" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
          <div class="input-group-append">
            <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
          </div>
        </div>
      ...
      <!-- ************************ -->
      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
        <p style="text-align: center;color:#4e73df;font-weight:bold;float:left" class="para_1">Starting Date</p><br><br><br>

        <input type="date" class="form-group" name="starting_date_time" style="width:80%;padding:3px;">
        <br>
        <p style="text-align: center;color:#4e73df;font-weight:bold;float:left" class="para_1">Follow-up Date</p><br><br><br>

        <input type="datetime-local" class="form-group" name="follow_up_date_time" style="width:80%;padding:3px;">
      </div>
      ...
      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 media_set">
        ...
        <!-- <div class="radio">
          <label>Other
            <input type="text" name="staff_opinion" id="other_textbox4" disabled placeholder="Other">
          </label>
        </div> -->

        <div class="input-group mb-3">
          <input type="text" name="staff_opinion" class="form-control" disabled id="other_textbox4" placeholder="Other" aria-label="Other" aria-describedby="basic-addon2">
          <div class="input-group-append">
            <!-- <span class="input-group-text" id="basic-addon2">%</span> -->
          </div>
        </div>
...
<script>
  function radioButton1(o) {
    ...
    if (o.value == "on") {
      ...
      // o.value="";
      // document.getElementById("other_textbox1").setAttribute("value", "%"); 
    } else {
